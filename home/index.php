...
<head>
    ...
    <style>
        ...
        .logo {
            flex: 0 0 auto; /* Ensure logo does not grow or shrink */
        }
...
<div class="box">
    <div class="discord">
        ...
        <h2>Price : RM 30</h2>
        <button class="buy" onclick="buyItem('Discord Bot', '30')">Buy</button>
    </div>
    <div class="website">
        <p>Website</p>
        <img src="../img/web.png">
        <h2>Price : RM 30</h2>
        <button class="buy" onclick="buyItem('Website', '30')">Buy</button>
    </div>
    <div class="gtav">
        <p>GTAV Account</p>
        <img src="../img/gtav.png">
        <h2>Price : RM 30</h2>
        <button class="buy" onclick="buyItem('GTAV Account', '30')">Buy</button>
    </div>
</div>
